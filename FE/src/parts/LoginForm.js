    ...
    users
      ...
      .then((res) => {
        ...
        users.details().then((detail) => {
          ...
          const redirect = localStorage.getItem("RAPMICRO:redirect");
          const userCookie = {
          ...
          document.cookie = `RAPMICRO:user=${JSON.stringify(
            userCookie
        ...
        <div className="relative" style={{ width: 369, height: 440 }}>
          ...
          >
            <p className="text-gray-900 mb-2">
              Metode belajar yang santuy seperti nonton Attack on Titan di Netflix
            </p>
            <span className="text-gray-600">Rayi, Apps Developer</span>
          </div>
        </div>
      </div>
    </div>
